...
namespace Sol_PuntoVenta.Datos
{
    public class D_Punto_Venta
    {
        ...
        public string Guardar_pv(int nOpcion, E_Punto_Venta oPropiead)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            ...
            try
            {
                ...
                Comando.Parameters.Add("@nCodigo", SqlDbType.Int).Value = oPropiead.Codigo_pv;
                Comando.Parameters.Add("@cDescripcion", SqlDbType.VarChar).Value = oPropiead.Descripcion_pv;
                SqlCon.Open();
        ...
        public string Eliminar_pv(int nCodigo)
        {
            ...
            try
            {
                ...
                SqlCon.Open();
                Rpta = Comando.ExecuteNonQuery()>=1? "OK" : "No sepudo eliminar el registro";
            }
            catch (Exception ex)
            {
